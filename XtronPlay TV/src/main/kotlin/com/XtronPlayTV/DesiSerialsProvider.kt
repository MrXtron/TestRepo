...
open class DesiSerialsProvider : MainAPI() {
    ...
    override var name = "XtronPlayTV (Source 1)"
    ...
    // Using the list of proxies from XtronPlayTVPlugin to generate dynamic entry points
    ...
    private fun proxyImage(url: String?): String? {
        ...
        val firstProxy = XtronPlayTVPlugin.proxy.firstOrNull() ?: return url
    ...
    override suspend fun loadLinks(
        ...
        allLinks.forEach {
            handleIframe(it, data, subtitleCallback, callback)
        }
        return true
    }
